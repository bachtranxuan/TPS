...
![Log predictive probability](./figures/perplexities.png =100x20 "Log predictive probability")
![Normalized pointwise mutual information](./figures/npmi.png =100x20 "Normalized pointwise mutual information")
